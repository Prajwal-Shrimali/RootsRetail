...
export 'merchant_profile_model.dart';

class MerchantProfileWidget extends StatefulWidget {
  const MerchantProfileWidget({Key? key}) : super(key: key);
...
class _MerchantProfileWidgetState extends State<MerchantProfileWidget>
  ...
  late MerchantProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MerchantProfileModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'miume6bo' /* Notification Settings */,
                            ),
                            style: FlutterFlowTheme.of(context).labelLarge,
                          ),
                        ),
