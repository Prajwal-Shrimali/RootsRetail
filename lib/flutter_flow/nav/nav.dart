...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'MerchantAccountCreation',
          path: '/merchantAccountCreation',
          builder: (context, params) => MerchantAccountCreationWidget(),
        ),
        FFRoute(
          name: 'TribalsDashboard',
          path: '/tribalsDashboard',
          builder: (context, params) => TribalsDashboardWidget(),
        ),
        FFRoute(
          name: 'TribalsSignUp',
          path: '/tribalsSignUp',
          builder: (context, params) => TribalsSignUpWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/tribalOrderConfirmation',
          builder: (context, params) => TribalOrderConfirmationWidget(),
        ),
        FFRoute(
          name: 'TribalDataEntry',
          path: '/tribalDataEntry',
          builder: (context, params) => TribalDataEntryWidget(),
        ),
        FFRoute(
          name: 'TribalSuccessPage',
          path: '/tribalSuccessPage',
          builder: (context, params) => TribalSuccessPageWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Roots-removebg-preview.png',
                    fit: BoxFit.none,
                  ),
                )
              : page;
