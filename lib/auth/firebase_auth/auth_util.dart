...
DocumentReference? get currentUserReference =>
    loggedIn ? TribalTableRecord.collection.doc(currentUser!.uid) : null;

TribalTableRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : TribalTableRecord.getDocument(TribalTableRecord.collection.doc(uid))
              .handleError((_) {}),
    )
